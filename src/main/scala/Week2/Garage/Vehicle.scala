...
object Vehicle {
  class Car(idc: Long, brandc: String, modelc: String, regNoc: String, costToFixc: Int) extends Vehicle {
    ...
    override def toString: String = s"ID: $id | Car | Brand: $brand  | Model: $model | Reg No: $regNo | Fixed: $isFixed | Cost to Fix if Broken: £$costToFix"
  }
  ...
  class Bike(idc: Long, brandc: String, typeOfBikec: String, costToFixc: Int)extends Vehicle {
    ...
    var costToFix: Int = costToFixc
    override def toString: String = s"ID: $id | Bike | Brand: $brand | Type of Bike: $typeOfBike | Fixed: $isFixed | Cost to Fix if Broken: £$costToFix"
  }
